...
> 구현 과정과 개선 내용은 [`dev_docs`](dev_docs/)에 단계별로 정리했습니다. → [1차 구현](dev_docs/1차_구현.md) · [2차 개선](dev_docs/2차_개선.md) · [3차 개선](dev_docs/3차_개선.md)
...
| [3차 개선](dev_docs/3차_개선.md) | 실제 표준프레임워크 문서 적재, 제목 기준 청킹, 고정 질문 10개로 측정 체계 도입, 화면 보강 |

각 문서에 구현 과정, 트러블슈팅, 실행 결과, 배운 점을 정리했습니다.

답변 품질은 고정 질문 12개로 잽니다. 질문과 재는 방법은 [평가 질문](dev_docs/평가_질문.md)에, 측정 결과는 날짜별로 나눠 두었습니다.

| 날짜 | 회차 | 무엇을 쟀나 |
| --- | --- | --- |
| [2026-09-25](dev_docs/질문_측정결과_0925.md) | 1~5차 | 전제 교정 규칙, top-k 5→8, 조각 순서 뒤집기 |
| [2026-09-26](dev_docs/질문_측정결과_0926.md) | 6~7차 | 공통컴포넌트·개발환경 30개 적재, 임계값 0.40→0.50 |
